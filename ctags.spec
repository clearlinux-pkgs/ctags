...
#
Name     : ctags
Version  : 6.0.20230820.0
Release  : 130
URL      : https://github.com/universal-ctags/ctags/archive/p6.0.20230820.0/ctags-6.0.20230820.0.tar.gz
Source0  : https://github.com/universal-ctags/ctags/archive/p6.0.20230820.0/ctags-6.0.20230820.0.tar.gz
...
%prep
%setup -q -n ctags-p6.0.20230820.0
cd %{_builddir}/ctags-p6.0.20230820.0
pushd ..
cp -a ctags-p6.0.20230820.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692627132
