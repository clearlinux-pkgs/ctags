...
#
Name     : ctags
Version  : 5.9.20221030.0
Release  : 86
URL      : https://github.com/universal-ctags/ctags/archive/p5.9.20221030.0/ctags-5.9.20221030.0.tar.gz
Source0  : https://github.com/universal-ctags/ctags/archive/p5.9.20221030.0/ctags-5.9.20221030.0.tar.gz
...
%prep
%setup -q -n ctags-p5.9.20221030.0
cd %{_builddir}/ctags-p5.9.20221030.0
pushd ..
cp -a ctags-p5.9.20221030.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667223857
