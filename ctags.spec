...
#
Name     : ctags
Version  : 6.0.20230416.0
Release  : 110
URL      : https://github.com/universal-ctags/ctags/archive/p6.0.20230416.0/ctags-6.0.20230416.0.tar.gz
Source0  : https://github.com/universal-ctags/ctags/archive/p6.0.20230416.0/ctags-6.0.20230416.0.tar.gz
...
%prep
%setup -q -n ctags-p6.0.20230416.0
cd %{_builddir}/ctags-p6.0.20230416.0
pushd ..
cp -a ctags-p6.0.20230416.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681742273
