...
%prep
%setup -q -n ctags-p5.9.20210822.0
cd %{_builddir}/ctags-p5.9.20210822.0
%patch1 -p1
...
cp %{_builddir}/ctags-p5.9.20210822.0/Units/parser-ldscript.r/ld-hello.d/LICENSE %{buildroot}/usr/share/package-licenses/ctags/3127907a7623734f830e8c69ccee03b693bf993e
cp %{_builddir}/ctags-p5.9.20210822.0/misc/packcc/LICENSE %{buildroot}/usr/share/package-licenses/ctags/b474bfe052cf74975a642031cdb6b449d7840f77
