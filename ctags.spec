...
Source0  : https://github.com/universal-ctags/ctags/archive/p5.9.20221002.0/ctags-5.9.20221002.0.tar.gz
...
%prep
%setup -q -n ctags-p5.9.20221002.0
cd %{_builddir}/ctags-p5.9.20221002.0
%patch1 -p1
pushd ..
cp -a ctags-p5.9.20221002.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664803898
