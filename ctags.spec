...
#
Name     : ctags
Version  : 5.9.20220227.0
Release  : 43
URL      : https://github.com/universal-ctags/ctags/archive/p5.9.20220227.0/ctags-5.9.20220227.0.tar.gz
Source0  : https://github.com/universal-ctags/ctags/archive/p5.9.20220227.0/ctags-5.9.20220227.0.tar.gz
...
%prep
%setup -q -n ctags-p5.9.20220227.0
cd %{_builddir}/ctags-p5.9.20220227.0
%patch1 -p1
pushd ..
cp -a ctags-p5.9.20220227.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645974121
...
cp %{_builddir}/ctags-p5.9.20220227.0/COPYING %{buildroot}/usr/share/package-licenses/ctags/74a8a6531a42e124df07ab5599aad63870fa0bd4
cp %{_builddir}/ctags-p5.9.20220227.0/Units/parser-ldscript.r/ld-hello.d/LICENSE %{buildroot}/usr/share/package-licenses/ctags/3127907a7623734f830e8c69ccee03b693bf993e
cp %{_builddir}/ctags-p5.9.20220227.0/misc/packcc/LICENSE %{buildroot}/usr/share/package-licenses/ctags/b474bfe052cf74975a642031cdb6b449d7840f77
cp %{_builddir}/ctags-p5.9.20220227.0/win32/license/LICENCE.pcre2 %{buildroot}/usr/share/package-licenses/ctags/cc7132d685cfac1cac53709962b52590e160450f
cp %{_builddir}/ctags-p5.9.20220227.0/win32/license/LICENSE.janssen %{buildroot}/usr/share/package-licenses/ctags/26a708b97cbb50e3fce8078dd21d65c8fdd5a605
cp %{_builddir}/ctags-p5.9.20220227.0/win32/license/LICENSE.libyaml %{buildroot}/usr/share/package-licenses/ctags/c01c212bdf3925189f673e2081b44094023860ea
pushd ../buildavx2/
%make_install_v3
popd
%make_install
